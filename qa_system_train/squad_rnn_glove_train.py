...
WEIGHT_FILE_PATH = MODEL_DIR + '/rnn-glove-weights.h5'
...
np.save(MODEL_DIR + '/rnn-glove-ans-word2idx.npy', ans_word2idx)
np.save(MODEL_DIR + '/rnn-glove-ans-idx2word.npy', ans_idx2word)
...
print(config)
np.save(MODEL_DIR + '/rnn-glove-context.npy', config)
...
json = model.to_json()
open(MODEL_DIR + '/rnn-glove-architecture.json', 'w').write(json)
